...
const PersonalDetailsForm = ({ onConfirm }: PersonalDetailsFormProps) => {
  ...
  const getInputClassName = (field: keyof StudentFormData) => {
    return `w-full px-6 py-4 rounded-full text-lg placeholder-[#685AAD] transition-all duration-300 bg-[#DBCAFF] text-[#534988] focus:outline-none ${
      errors[field]
  ...
  const getLabelClassName = (field: keyof StudentFormData) => {
    return `block text-[#685AAD] text-lg font-medium mb-2 text-center ${
    ...
    >
      <div className='space-y-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8'>
          <div>
            ...
            <div className='relative'>
              ...
              >
                <span
                  className={
                    formData.country ? 'text-[#534988]' : 'text-[#685AAD]'
                  }
                >
                    ...
                    {countries.map((country, index) => (
                      ...
                      >
                        <div className='border-b border-[#a394d682] py-3 flex items-center w-full px-4 hover:bg-[#a394d682] transition-colors duration-200'>
                          <span className='text-lg text-[#6C5BAA]'>
                            {country}
                          </span>
                        </div>
                      </div>
          ...
          <div>
            <label className={getLabelClassName('stateCity')}>
              State / City
            </label>
            <div className='relative'>
              <div
                onClick={() =>
                  formData.country &&
                  setIsStateCityDropdownOpen(!isStateCityDropdownOpen)
                }
              ...
              >
                <span
                  className={
                    formData.stateCity ? 'text-[#534988]' : 'text-[#685AAD]'
                  }
                >
          ...
          <div>
            <label className={getLabelClassName('institution')}>
              Institution
            </label>
            <input
              type='text'
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8'>
          <div>
            <label className={getLabelClassName('streetName')}>
              Street Name
            </label>
            <input
              type='text'
        ...
        <div className='flex justify-end mt-12 pt-4'>
          <button
            ...
            className='bg-[#9184F0] text-white px-16 py-4 rounded-full text-lg font-semibold hover:bg-[#7A6BD9] transition-all duration-300 shadow-lg hover:shadow-xl'
          >
            Confirm
          </button>
        </div>
